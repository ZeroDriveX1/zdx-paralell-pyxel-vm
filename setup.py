...
_TOP_LEVEL_MODULES = sorted(
    path.stem for path in Path(".").glob("zdx_*.py")
...
setup(
    ...
    py_modules=_TOP_LEVEL_MODULES,
    entry_points={"console_scripts": [
        "zdx=zdx_cli:main",
        "zdx-worker=zdx_worker:main",
        "zdx-session-worker=zdx_session_worker:main",
        "zdx-mission=zdx_mission_cli:main",
    ]},
